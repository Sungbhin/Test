...
#include "sys_pck1.h"  /*lint !e451 !e537 repeated include file */
	...
	#define PE_GET_MEASUREMENT_LIST				0x10	//modifier 0x03
	#define PE_GET_MEASUREMENT_VALUES			0x10	//modifier 0x04
	...
	#define PE_MOD_GET_MEASUREMENT_LIST			0x03
	#define PE_MOD_GET_MEASUREMENT_VALUES		0x04
    ...
    {
    	PNIO_UINT32 	( *pe_method_ptr) (PNIO_UINT8 *, PNIO_UINT8 *);
